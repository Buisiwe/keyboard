...
//try to return upper or lower case
  const shiftHandler = (e) => {
    const upperCaseText = currentlyFocusedInput.toUpperCase();
    const lowerCaseText = currentlyFocusedInput.toLowerCase();
    setCurrentlyFocusedInput((currFoc) => { 
      let val = currFoc.value + e.target.value;
    
    if (lowerCaseText.toLowerCase() === true) {

      // To convert Upper Case
      setCurrentlyFocusedInput.defaultText.toUpperCase(upperCaseText)}
      
    else {
      // To convert Lower Case
    setCurrentlyFocusedInput.defaultText.toLowerCase(lowerCaseText);
    }
    return val;
    });
    }
  ...
  return (
    <div className="App">
      ...
      <div className="keyboard-container">
        ...
        <div className="key-row">
          <button value="" onClick={shiftHandler} className="btn-shift">Shift</button>
        ...
        <div className="key-row">
          <button value=" " onClick={buttonHandler} className="btn-full">Space</button>
        </div>
      </div>
    </div>
  );
